...
class WidgetTestsExtended extends WidgetTests {
    ...
    async runExtendedTests() {
        this.clearResults();
        this.logTestHeader('Running Extended Tests');
        ...
        this.logTestResult('Extended Tests Complete', true);
    }
    ...
    async testBrandingVisibility() {
        try {
            ...
            this.logTestResult('Branding visibility test', allVisible, 
                allVisible ? 'All branding elements are visible' : 'Some branding elements are hidden');
            
            return allVisible;
        } catch (error) {
            this.logTestResult('Branding visibility test', false, `Error: ${error.message}`);
            return false;
        }
    }
    ...
    async testImageLoading() {
        try {
            ...
            this.logTestResult('Image loading test', result, 
                `${loadedCount}/${images.length} images loaded successfully`);
            
            return result;
        } catch (error) {
            this.logTestResult('Image loading test', false, `Error: ${error.message}`);
            return false;
        }
    }
    ...
    async testPrivacyLink() {
        try {
            ...
            this.logTestResult('Privacy link test', hasCorrectHref, 
                hasCorrectHref ? 'Privacy link is properly configured' : 'Privacy link is missing or misconfigured');
            
            return hasCorrectHref;
        } catch (error) {
            this.logTestResult('Privacy link test', false, `Error: ${error.message}`);
            return false;
        }
    }
    ...
    async testResponsiveLayout() {
        try {
            ...
            this.logTestResult('Responsive layout test', isGridOrFlex, 
            ...
            this.logTestResult('Item width test for ' + config.deviceType, isCorrectWidth, 
                `Item width is ${firstItemWidth}`);
            
            return isGridOrFlex && isCorrectWidth;
        } catch (error) {
            this.logTestResult('Responsive layout test', false, `Error: ${error.message}`);
            return false;
        }
    }
    ...
    async testAdOriginLabels() {
        try {
            ...
            this.logTestResult('Ad origin labels test', allHaveSponsored, 
                allHaveSponsored ? 'All ads properly labeled as sponsored' : 'Some ads missing sponsored label');
            
            return allHaveSponsored;
        } catch (error) {
            this.logTestResult('Ad origin labels test', false, `Error: ${error.message}`);
            return false;
        }
    }
    ...
    /**
     * Log a header for a test section
     */
    logTestHeader(message) {
        if (this.resultsContainer) {
